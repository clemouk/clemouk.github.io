    ...
    for (const t of e.entities.reverse()) {
        ...
        if (t?.content && "Attachment" == t.content[0].contentType) {
            if ("Image" == t.content[0].attachment.mediaType && t.content[0].attachment.mime.includes("jpeg")) {
                ...
                e = await n.embedJpg(i),
                e.height > g && (d = g / e.height)
            }
            if ("Image" == t.content[0].attachment.mediaType && t.content[0].attachment.mime.includes("png")) {
                const i = await fetch(t.content[0].attachment.url).then((e => e.arrayBuffer()));
                e = await n.embedPng(i),
                e.height > g && (d = g / e.height)
            }
        }
        if (t.text) {
            if (newPageNeeded_rec_txt(o, i, t.text, r, a, c, 12).value && (o = n.addPage(),
            r = 3),
        ...
        if (e) {
            newPageNeeded_rec_img(o, r, c, e.scale(d).height, 12) && (o = n.addPage(),
            r = 3);

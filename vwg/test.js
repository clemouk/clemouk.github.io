if(Bootstrapper.data.resolve("Manage.eventInfo.pageId").includes("www.volkswagen-vans.co.uk/en/test-section/multivan-copy.html")){
    "use strict";
    ...
    function agentText(e, t, n, i, o, a, c, g) {
      let r = i + 2,
        d = r + 1,
        s = newPageNeeded_rec_txt(e, t, n, i, o, a, c);
      e.drawText("VWCV", { x: o - 70, y: a - i * c, size: c, font: t });
      let h = {
        x: o - s.rec.width - 20,
        y: a - r * c,
        maxWidth: o - 40,
    ...
    Genesys("subscribe", "Launcher.ready", function () {
      (gc_token = JSON.parse(
        localStorage.getItem("7082b91f-5ffd-4508-8ff6-b58ff931b058:actmu")
      ).value)
    });
    const testPrintIcon =

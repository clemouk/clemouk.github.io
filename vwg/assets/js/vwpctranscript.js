  ...
  if(localStorage.getItem('_ttecConversationState')!='NEW') {  
    try {
      (gc_socket = new WebSocket(
        "wss://webmessaging.euw2.pure.cloud/v1?deploymentId=df4cb5a9-5845-47b8-bff8-a7a919cb23e6"
      )),
        ...
        console.log(
          "Waiting for events on wss://webmessaging.euw2.pure.cloud/v1?deploymentId=df4cb5a9-5845-47b8-bff8-a7a919cb23e6"
        ),

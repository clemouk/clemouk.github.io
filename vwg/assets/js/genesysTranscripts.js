...
// gc_deploymentId = '7082b91f-5ffd-4508-8ff6-b58ff931b058';
// gc_region = 'euw2.pure.cloud';
...
async function createPdf(e) {
  ...
  (s.href = d), (s.download = "myconversation.pdf"), s.click(), loadingOff();
}
...
Genesys("subscribe", "Messenger.ready", (function () { gc_token = JSON.parse(localStorage.getItem(`_${gc_deploymentId}:actmu`)).value, displayButton() }));
